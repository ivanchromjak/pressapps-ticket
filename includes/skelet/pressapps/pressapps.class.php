 ...
 */
 class PressApps{
		...
		public static function load_header(){
				wp_enqueue_style( 'pressapps-ticket', plugin_dir_url(__FILE__ )."assets/css/pressapps.css" );
				wp_enqueue_script( 'pressapps-ticket', plugin_dir_url(__FILE__ )."assets/js/pressapps.js"  , array(), '1.0.0', true );
		} 
